...
Represents: a folder with manuscript notes, exported LaTeX files, selected figures, duplicate finals, and raw/cache outputs.
...
Expected result: a triage report identifying likely manuscript files, candidate figures/tables, and files that should not move into the manuscript repo.
