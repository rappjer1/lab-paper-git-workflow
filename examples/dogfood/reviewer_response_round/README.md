...
Represents: a revision handoff where artifacts and checks need to be organized before writing confidential response text elsewhere.
...
Expected result: a response checklist and evidence folder.
