...
Represents: a final pre-submission check after the manuscript repo validates.
...
Expected result: a clean package folder with manuscript source and referenced artifacts.
