...
Represents: a research project with selected publication artifacts and nearby raw outputs that should not be copied wholesale.
...
Expected result: Paper Scaffold suggests the small PDF/CSV/TEX files and ignores raw/cache-like files.
