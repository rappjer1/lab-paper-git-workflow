...
\begin{abstract}
This synthetic manuscript demonstrates a clean paper repository with a copied figure, a bibliography entry, and artifact provenance.
\end{abstract}

\section{Example Result}

Figure~\ref{fig:example-metric} shows a synthetic result generated by the example Python workflow. This example cites a placeholder reference \citep{example_reference} so bibliography checks have a complete citation path.
