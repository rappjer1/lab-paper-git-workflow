...
SCHEMAS: dict[str, SchemaReference] = {
    ...
    "provenance-ledger": SchemaReference(
        ...
        minimal_example='{"tool": "Paper Scaffold", "version": "0.9.1", "summary": {"current": 1}, "artifacts": []}',
    ),
    "artifact-lock": SchemaReference(
        ...
        minimal_example='{"tool": "Paper Scaffold", "version": "0.9.1", "artifacts": [{"artifact_id": "fig1", "manuscript_path": "figures/fig1.pdf", "manuscript_sha256": "..."}]}',
    ),
    "validation-report": SchemaReference(
        ...
        minimal_example='{"tool": "Paper Scaffold", "version": "0.9.1", "summary": {"errors": 0, "warnings": 0, "info": 1}, "diagnostics": []}',
    ),
